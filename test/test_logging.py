...
class TestValidationSampleLogger:
    ...
    def test_flush_clears_buffers(self, logger):
        logger.collect_classification("t", torch.tensor([0.5, 0.5]), "Yes")
